package knari.com.knari.webapp.spring;
...
@Configuration
@ComponentScan({ "knari.com.knari.webapp" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "knari.com.knari.webapp");
                servletContext.setInitParameter("tapestry.development-modules", "knari.com.knari.webapp.services.DevelopmentModule");
